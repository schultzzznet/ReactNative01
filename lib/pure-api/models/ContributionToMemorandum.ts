...
*/
export class ContributionToMemorandum extends ResearchOutput {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ContributionToMemorandum.attributeTypeMap);
    }
    
    public constructor() {
        super();
        this.typeDiscriminator = "ContributionToMemorandum";
    }
}
